...
class Deposit(commands.Cog):
    ...
    async def deposit(self, ctx, amount:Option(str, "Amount of coins to deposit, max for all", required=True)):
        ...
        embed.add_field(name="Current Wallet Balance", value = f"**{walletBalance-amount} EdCoins 🪙**", inline = False)
        embed.add_field(name="Current Bank Balance", value = f"**{bankBalance} EdCoins 🪙**", inline = False)
